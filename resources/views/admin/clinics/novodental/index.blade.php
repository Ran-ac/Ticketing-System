  ...
  <!-- Main wrapper -->
	<div class="body-wrapper">
		...
		<div>
            <main>
                <div class="container">
                    <h1 class="mt-4">Novodental clinics</h1>
                    <ol class="breadcrumb mb-2">
                        <li class="breadcrumb-item active">All clinics of novodental </li>
                    </ol>
					...
					<div class="card mb-4">
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-striped table-hover" id="novodentalTable" width="100%" cellspacing="0">
								<thead>
									<tr>
									<th>Id</th>
									<th>Company</th>
...
$(document).ready(function () {
		...
		let table = $("#novodentalTable").DataTable({
			processing: true,
			serverSide: true,
			ajax: "{{ route('admin.clinics.novo.fetchNovoClinicsData') }}", // Fetching data via AJAX
			columns: [
				{ data: "id", name: "id" },
